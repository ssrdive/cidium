...
func (app *application) routes() http.Handler {
	...
	r.HandleFunc("/dropdown/condition/{name}/{where}/{value}", http.HandlerFunc(app.dropdownHandler)).Methods("GET")
	r.HandleFunc("/dropdown/condition/accounts/{name}/{where}/{value}", http.HandlerFunc(app.dropdownConditionAccountsHandler)).Methods("GET")
	...
	r.HandleFunc("/contract/legacy/new", http.HandlerFunc(app.newLegacyContract)).Methods("POST")
